      ...
      <View style={styles.container}>
        ...
        <View style={styles.textoCadastroContainer}>
          ...
          <View style={styles.textInputBackground}>
            <TextInput style={styles.textInputStyle} placeholder="Nome" maxLength = {40} onChangeText={(nomeCadastro) => this.setState({nomeCadastro: nomeCadastro})}/>
          </View>
        </View>
        </LinearGradient>
        ...
        <View style={styles.progressoCadastroContainer}>
          <Image source={require('../assets/icons/fluxoCadastro1-5/drawable-xhdpi/cadastro1-5.png')}/>
        </View>

        {/*Botao de Confirmar*/}
        <View style={styles.botaoConfirmarContainer}>
          <TouchableHighlight onPress={() => this.props.navigation.navigate('RegisterEmail', {paramNomeCadastro: this.state.nomeCadastro,})}>
