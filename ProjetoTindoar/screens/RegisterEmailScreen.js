...
export default class App extends Component {
  ...
  constructor(App){
    super(App);
    this.state = {emailCadastro: "NULLdoEMAIL"};
  }
      ...
      <View style={styles.container}>
        ...
        <View style={styles.textoCadastroContainer}>
          ...
          <View style={styles.textInputBackground}>
            <TextInput style={styles.textInputStyle} placeholder="Email" onChangeText={(emailCadastro) => this.setState({input: emailCadastro})}/>
          </View>
        </View>
        </LinearGradient>
        ...
        <View style={styles.progressoCadastroContainer}>
          <Image source={require('../assets/icons/fluxoCadastro2-5/drawable-xxhdpi/cadastro2-5.png')}/>
        </View>
